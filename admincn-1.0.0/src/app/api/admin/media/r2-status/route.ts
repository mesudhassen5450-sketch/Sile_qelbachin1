...
/** Quick online-storage credential / bucket check for Admin UI banners. */
export async function GET() {
  ...
  return NextResponse.json({
    ...
    fix:
      'Render → Sile_qelbachin1-1 → Environment: set R2_ACCESS_KEY_ID (exactly 32 chars) and R2_SECRET_ACCESS_KEY (~64 chars) from your R2 API token (Object Read & Write). Then Manual Deploy → Deploy latest commit. Do not put “key”, “value”, or a short placeholder.'
  })
}
