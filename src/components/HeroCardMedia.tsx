...
/**
 * Hero card still — always the heart image, instant (no Next/Image fade / no video swap).
 * Intro recitation audio is handled separately by IntroRecitationProvider.
 */
export default function HeroCardMedia() {
  ...
  return (
    <div className="relative w-full aspect-[2/1] rounded-2xl overflow-hidden border border-neutral-800 bg-neutral-950">
      {/* eslint-disable-next-line @next/next/no-img-element -- instant paint, no blur placeholder */}
      <img
        src={HERO_STILL}
