...
export default function Navbar() {
  ...
  return (
    <header className="notranslate relative z-40 bg-white/95 dark:bg-neutral-900/95 border-b border-neutral-200 dark:border-neutral-800 backdrop-blur-md transition-colors">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-2 flex-nowrap">
        
        {/* Mobile hamburger stays on the left, next to the logo */}
        <button
        ...
        <Link href="/" className="flex items-center space-x-2 sm:space-x-3 group min-w-0 flex-1 lg:flex-none">
          <div className="relative w-9 h-9 sm:w-11 sm:h-11 rounded-full overflow-hidden border-2 border-red-600/30 group-hover:border-red-600 transition shadow-sm bg-neutral-800 flex-shrink-0">
            <Image
              src="/logo.jpg"
          ...
          <div className="flex flex-col min-w-0">
            <span className="font-bold text-base sm:text-xl tracking-tight text-neutral-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-400 transition truncate">
              {siteMetadata.channelName}
            </span>
            <span className="hidden xs:block sm:block text-2xs text-neutral-500 dark:text-neutral-400 font-mono -mt-1 truncate">
        ...
        <nav className="hidden lg:flex items-center space-x-1 font-medium">
          ...
          <div className="relative" ref={subpagesRef}>
            ...
            <div
              ...
              className={`absolute top-full start-0 mt-2 w-60 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-xl py-2 z-50 ${
                isSubpagesOpen ? 'block animate-in fade-in slide-in-from-top-2 duration-150' : 'hidden'
              }`}
            >
        ...
        {/* Controls: language + theme. Hamburger is on the left on mobile. */}
      ...
      {isMenuOpen && (
        <div className="lg:hidden">
          ...
          />
          <div className="fixed top-[var(--site-header-height)] left-0 right-0 z-40 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 px-6 py-6 space-y-4 shadow-xl max-h-[85vh] overflow-y-auto">
